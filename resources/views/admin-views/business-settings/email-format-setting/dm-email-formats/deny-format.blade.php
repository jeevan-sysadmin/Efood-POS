    ...
    <div class="content container-fluid">
        ...
        <div class="tab-content">
            <div class="tab-pane fade show active">
                <div class="card mb-3">
                    @php($mail_status=\App\Model\BusinessSetting::where('key','deny_mail_status_dm')->first())
                ...
                <form action="{{ route('admin.business-settings.email-setup.update', ['dm','deny']) }}" method="POST" enctype="multipart/form-data">
                    @csrf
