...
{{--                                        <div class="swiper-slide">--}}
{{--                                            <div class="d-flex flex-column align-items-center mx-w450 mx-auto">--}}
{{--                                                <img src="{{asset('public/assets/admin/img/slider-3.png')}}" loading="lazy"--}}
{{--                                                     alt="" class="dark-support rounded mb-4">--}}
{{--                                                <p>--}}
{{--                                                    {{ translate('now_you’ll_be_successfully_able_to_use_the_payment_gateway_addon_on_your_website') }}--}}
{{--                                                </p>--}}
{{--                                                <p>--}}
{{--                                                    {{ translate('N:B you_can_upload_only_gateway_zip') }}.--}}
{{--                                                </p>--}}
